  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12" style="margin-top: 10px">
        <div class="row">
<table width="1000" border="0" align="center" class="square">
...
//connect db
	...
	//แสดงรายละเอียด
	echo "<tr>";
  	echo "<td width='200' valign='top'><b>Title</b></td>";
    echo "<td width='279'>" . $row["p_name"] . "</td>";
    echo "<td width='100' rowspan='4'><img src='../p_img/" . $row["p_img"] . " ' width='100'></td>";
  	echo "</tr>";
  	echo "<tr>";
