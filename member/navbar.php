...
<div class="container">
  <div class="row">
    ...
    <img src="../m_img/<?php echo $m_img ?>" width="30" height="30" class="d-inline-block align-top" alt="">
    <?php echo $m_name; ?>
  </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            &nbsp;
            <div class="btn-group">
              <a class="btn btn-Light" href="product.php" role="button">ซื้อสินค้า</a>
            </div>
            &nbsp;
            <div class="btn-group">
              <a class="btn btn-Light" href="satatus.php" role="button">ติดตามการสั่งซื้อ</a>
            </div>
            &nbsp;
            <li class="nav-item">
